...
async function main() {
  ...
  await prisma.assignment.createMany({
    data: [
      { title: 'Module Test 1', dueDate: new Date('2025-03-26T10:00:00+02:00'), maxScore: 100, score: 82, weight: 50, status: 'GRADED', type: 'TEST', moduleId: stk110.id, componentId: cModuleTests.id },
      { title: 'Module Test 2', dueDate: new Date('2025-05-10T10:00:00+02:00'), maxScore: 100, score: null, weight: 25, status: 'PENDING', type: 'TEST', moduleId: stk110.id, componentId: cModuleTests.id },
      { title: 'Formal Practical Test', dueDate: new Date('2025-05-23T10:00:00+02:00'), maxScore: 50, score: 40, weight: 25, status: 'GRADED', type: 'PRACTICAL', moduleId: stk110.id, componentId: cPractical.id },
      { title: 'Pre-class Assignment 1', dueDate: new Date('2025-02-17T08:00:00+02:00'), maxScore: 10, score: 9, weight: 12.5, status: 'GRADED', type: 'OTHER', moduleId: stk110.id, componentId: cContinuous.id },
      { title: 'Post-class 1', dueDate: new Date('2025-03-07T10:00:00+02:00'), maxScore: 10, score: 8, weight: 12.5, status: 'GRADED', type: 'OTHER', moduleId: stk110.id, componentId: cContinuous.id },
    ],
  });
  ...
  await prisma.assignment.createMany({
    data: [
      { title: 'Quiz 1', dueDate: new Date('2025-03-10T10:00:00+02:00'), maxScore: 100, score: 90, weight: 10, status: 'GRADED', type: 'QUIZ', moduleId: inf171.id },
      { title: 'Quiz 2', dueDate: new Date('2025-04-11T10:00:00+02:00'), maxScore: 100, score: 85, weight: 10, status: 'GRADED', type: 'QUIZ', moduleId: inf171.id },
      { title: 'Tutorial 1: Rich Picture', dueDate: new Date('2025-02-24T10:00:00+02:00'), maxScore: 100, score: 100, weight: 10, status: 'GRADED', type: 'OTHER', moduleId: inf171.id },
      { title: 'Group Assignment 1', dueDate: new Date('2025-08-07T10:00:00+02:00'), maxScore: 100, score: null, weight: 20, status: 'PENDING', type: 'GROUP', moduleId: inf171.id },
  ...
  await prisma.assignment.createMany({
    data: [
      { title: 'Chapter 11-12 Connect', dueDate: new Date('2025-08-08T10:00:00+02:00'), maxScore: 100, score: null, weight: 30, status: 'PENDING', type: 'OTHER', moduleId: ekn120.id, componentId: eknConnect.id },
      { title: 'Semester Test 1', dueDate: new Date('2025-08-23T10:00:00+02:00'), maxScore: 100, score: null, weight: 25, status: 'PENDING', type: 'TEST', moduleId: ekn120.id, componentId: eknSem.id },
      { title: 'Semester Test 2', dueDate: new Date('2025-10-13T10:00:00+02:00'), maxScore: 100, score: null, weight: 25, status: 'PENDING', type: 'TEST', moduleId: ekn120.id, componentId: eknSem.id },
    ],
  });
  ...
  await prisma.assignment.createMany({
    data: [
      ...
      { title: 'Overdue Practice Set', dueDate: twoDaysAgo, maxScore: 100, score: null, weight: 5, status: 'LATE', type: 'PRACTICAL', moduleId: ekn120.id },
      // Upcoming assignment due in 2 days
      { title: 'Upcoming Short Quiz', dueDate: twoDaysFromNow, maxScore: 20, score: null, weight: 5, status: 'PENDING', type: 'QUIZ', moduleId: ekn120.id },
      // Low graded item to make EKN120 at-risk (<50% average on graded)
      { title: 'Pop Quiz 0', dueDate: new Date(now.getTime() - 24 * 60 * 60 * 1000), maxScore: 100, score: 20, weight: 5, status: 'GRADED', type: 'QUIZ', moduleId: ekn120.id },
    ],
  });
